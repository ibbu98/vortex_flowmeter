...
#define CLOCK_FREQUENCY_MHZ 64
#define CODE_VERSION "4.0 2025/09/11"   /*   YYYY/MM/DD  */
#define COPYRIGHT "Copyright (c) University of Colorado" 
     
 enum boolean { FALSE, TRUE };           /// \enum boolean  
 enum dmode {QUIET, NORMAL, DEBUG_MODE, VERSION_MODE};
...
extern void UART_direct_msg_put(const uchar8_t *);
                                             /* located in module UART_poll.c */
extern void UART_msg_put(const uchar8_t *); 
                                             /* located in module UART_poll.c */
